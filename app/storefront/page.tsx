...
import { 
  Scissors, CheckCircle2, Shield, IndianRupee, 
      ...
      <section className="py-16 bg-white dark:bg-[#1A1816] border-y border-maroon/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <p className="text-sm text-charcoal/60 dark:text-primary-bg/60">Our promise to deliver perfection in every stitch</p>
          </div>
